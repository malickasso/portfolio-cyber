<section id="skills" class="py-24 border-t border-border-soft bg-bg-dark relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <!-- Grille des cartes de compétences (2 cartes par ligne) -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div
                ...
                <div>
                    ...
                    <h3 class="font-bold text-2xl text-white group-hover:text-accent transition-colors mb-3">
                        Fullstack Web Dev
                    </h3>
                    <p class="text-gray-400 text-base mb-6 leading-relaxed">
                        Conception et développement d'applications web modernes, évolutives et structurées : Laravel,
                        React, Django, PHP, Tailwind CSS, PostgreSQL, MySQL.
                    </p>
                </div>
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-base mb-6 leading-relaxed">
                        Évaluation de la sécurité des applications, tests d'intrusion et audits de vulnérabilités :
                        OWASP Top 10, Burp Suite, OWASP ZAP, Metasploit, Nmap.
                    </p>
                </div>
                <div class="pt-6 border-t border-border-soft/60 flex items-center justify-between">
                    <span class="font-mono text-xs text-gray-500 uppercase tracking-wider">Scope:</span>
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-base mb-6 leading-relaxed">
                        Administration, segmentation et sécurisation des réseaux et serveurs : Linux (Kali/Ubuntu),
                        GNS3, VLAN, VPN, LDAP, Active Directory.
                    </p>
                </div>
                <div class="pt-6 border-t border-border-soft/60 flex items-center justify-between">
                    <span class="font-mono text-xs text-gray-500 uppercase tracking-wider">Scope:</span>
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-gray-400 text-base mb-6 leading-relaxed">
                        Conteneurisation, automatisation du déploiement et intégration continue sécurisée : Docker, AWS,
