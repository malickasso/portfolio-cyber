                ...
                <article
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <?php if(!empty($post['image']) && file_exists(public_path($post['image']))): ?>
                                ...
                                <div
                                    ...
                                    <div class="z-10 my-auto">
                                        ...
                                        <h4 class="font-mono text-xs font-bold text-gray-200 line-clamp-2">
                                            cat <?php echo e(Str::slug($post['title'])); ?>.md
                                        </h4>
                                    </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between font-mono text-xs text-gray-500 mb-3">
                                ...
                                <span>// <?php echo e($post['read_time'] ?? '5 min read'); ?></span>
                            </div>
...
<?php /**PATH /home/malick/Documents/Mes_Projets/portfolio-cyber/resources/views/sections/blog.blade.php ENDPATH**/ ?>