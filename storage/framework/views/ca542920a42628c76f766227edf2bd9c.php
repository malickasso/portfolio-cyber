<footer class="border-t border-border-soft bg-bg-dark pt-16 pb-12 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
            ...
            <div>
                ...
                <ul class="space-y-2.5 font-mono text-xs">
                    ...
                    <li>
                        <a href="<?php echo e(asset('cv.pdf')); ?>" download
        ...
        <div
            ...
            <div>
                © <?php echo e(date('Y')); ?> <span class="text-gray-300 font-semibold">ASSOUMA Abdou Malick</span>. All Rights
                Reserved.
            </div>
...
<?php /**PATH /home/malick/Documents/Mes_Projets/portfolio-cyber/resources/views/partials/footer.blade.php ENDPATH**/ ?>